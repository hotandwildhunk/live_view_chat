defmodule LiveViewChatWeb.RoomLive do
  ...
  def mount(%{"id" => room_id}, _session, socket) do
    ...
    if connected?(socket) do
      ...
      LiveViewChatWeb.Presence.track(self(), topic, username, %{})
    end
  ...
  def handle_event("submit_message", %{"chat" => %{"message" => message}}, socket) do
    ...
    LiveViewChatWeb.Endpoint.broadcast(socket.assigns.topic, "new-message", message)
  ...
  def handle_info(%{event: "presence_diff", payload: %{joins: joins, leaves: leaves}}, socket) do
    ...
    user_list =  LiveViewChatWeb.Presence.list(socket.assigns.topic)
    |> Map.keys()
